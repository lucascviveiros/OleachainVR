...
public class VG_GraspStudio : MonoBehaviour
{
    ...
    public bool Initialize()
    {
        ...
        m_editorAvatarID = FindObjectOfType<VG_MainScript>().m_sensors[0].m_avatars[0].m_avatarID;
        m_gameAvatarID = FindObjectOfType<VG_MainScript>().m_sensors[1].m_avatars[0].m_avatarID;
